...
export default Component.extend({
  ...
  actions: {
    ...
    launchItAll(){
      ...
      this.set("visWidth", editorSize.x);
      this.set("visHeight", editorSize.y);
      ...
      // const editorPaperNode = editorNode.getElementsByClassName("editor__paper")[0];
      ...
      // visNode.style="position: absolute; left: 0; right: 0; top: 0; bottom: 0; z-index: 10";

      const visNode = document.getElementById("mynetwork");

      var network = new Vis.Network(visNode, data, options);

      this.set("hasVis", true);
